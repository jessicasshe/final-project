 ...
 * @author JessicaS
 */
public class OptionPaneTester extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(OptionPaneTester.class.getName());
