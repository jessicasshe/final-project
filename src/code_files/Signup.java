...
public class Signup extends javax.swing.JFrame {
    ...
    public Signup(WindowManager manager, Validator validator, DBOperator db_operator) {
        initComponents();
        this.pack();
    ...
    private void initComponents() {
        ...
        signup_option_pane = new javax.swing.JOptionPane();
    ...
    private void signup_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signup_btnActionPerformed
        ...
        if(validator.isEmpty(name_text.getText().trim()) || validator.isEmpty(email_text.getText().trim()) || validator.isEmpty(password_text.getText().trim()))
        {
            manager.showErrorMessage(signup_option_pane, "Cannot leave any fields empty, please try again.");
        }
        else
        {
            ...
            else
            {
               ...
               {
                   manager.showErrorMessage(signup_option_pane, "Could not create user.");
               }
            }
        }  
    ...
    private javax.swing.JOptionPane signup_option_pane;
